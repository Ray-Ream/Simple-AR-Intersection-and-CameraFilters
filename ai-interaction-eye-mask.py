...
# 載入更換眼睛圖案的圖片
eye_normal = cv2.imread("Materials/eye.png")
    ...
    while cap.isOpened():
        ...
        if results.multi_face_landmarks:
            ...
            for face_landmarks in results.multi_face_landmarks:
                ...
                for index in eye_list:
                    ...
                    if index == 153 or index == 159:
                        eye_size.append([x, y])
                if len(eye_size) == 2:
                    eye_len = int(math.pow(
                        math.pow((eye_size[0][0] - eye_size[1][0]), 2) + math.pow((eye_size[0][1] - eye_size[1][1]), 2),
                        0.5))
            ...
            try:
                ...
                eye = cv2.resize(eye_normal, (eye_len + 10, eye_len + 10))
